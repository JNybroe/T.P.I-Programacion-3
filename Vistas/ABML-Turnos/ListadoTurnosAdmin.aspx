<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoTurnosAdmin.aspx.cs" Inherits="Vistas.ABML_Turnos.ListadoTurnosAdmin" %>
        ...
        <div class="contenedor">
            ...
            <div class="grupo">
                ...
                <div class="division">
                    ...
                    <asp:Label Text="" ForeColor="Red" ID="lblTxtboxVacio" runat="server" />
                </div>
                <div class="division">
                ...
                <div class="division">
                    ...
                    <asp:DropDownList ID="ddlEspecialidades" runat="server" CssClass="txt" AutoPostBack="True" OnSelectedIndexChanged="ddlCriterioBusqueda_SelectedIndexChanged">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="grupo">
            ...
            <asp:GridView runat="server" ID="gvTurnos" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" CssClass="txt" OnRowCommand="gvTurnos_RowCommand" OnPageIndexChanging="gvTurnos_PageIndexChanging">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Medico Encargado">
                        <ItemTemplate>
                            <asp:Label ID="lbl_it_Medico" runat="server" Text='<%# Bind("MedicoEncargado") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
