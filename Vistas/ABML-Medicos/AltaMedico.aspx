...
<head runat="server">
    ...
    <title>Alta de Médicos - Clinica G21</title>
    <style>
        body, html {
            height: 100%;
            margin: 0;
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="contenedor">
            ...
            <div class="grupo">
                <div class="division">
                    <asp:Label ID="lblLegajoMedico" runat="server" Text="Legajo del médico:" CssClass="lbl"></asp:Label>
                    <asp:TextBox ID="txtLegajoMedico" runat="server" CssClass="txt" ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvLegajoMedico" runat="server" ControlToValidate="txtLegajoMedico" CssClass="lblError">Este campo es obligatorio</asp:RequiredFieldValidator>
                    <br />
                    <asp:RegularExpressionValidator ID="revLegajo" runat="server" ControlToValidate="txtLegajoMedico" ErrorMessage="Caracteres Alfanumericos" CssClass="lblError" ValidationExpression="^[a-zA-Z0-9]+$"></asp:RegularExpressionValidator>
                </div>
                <div class="division">
                    <asp:Label ID="lblEspecialidad" runat="server" Text="Especialidad:" CssClass="lbl"></asp:Label>
                    <asp:DropDownList ID="ddlEspecialidad" runat="server" CssClass="txt">
                    </asp:DropDownList>
                    
                </div>
                <div class="division">
                    <asp:Label ID="lblProvincia" runat="server" Text="Provincia:" CssClass="lbl"></asp:Label>
                    <asp:DropDownList ID="ddlProvincia" runat="server" CssClass="txt" OnSelectedIndexChanged="ddlProvincia_SelectedIndexChanged" AutoPostBack="True">
                    </asp:DropDownList>
                </div>
                <div class="division">
                ...
                <div class="division">
                    <asp:Label ID="lblIdentificadorUsuario" runat="server" Text="Identificador Usuario:" CssClass="lbl"></asp:Label>
                    <asp:TextBox ID="txtIdentificadorUsuario" runat="server" CssClass="txt"  Enabled="false"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvIdentificadorUsuario" runat="server" ControlToValidate="txtIdentificadorUsuario" CssClass="lblError">Este campo es obligatorio</asp:RequiredFieldValidator>
                </div>
                <div class="division">
                    ...
                    <asp:RequiredFieldValidator ID="rfvNombreUsuario" runat="server" ControlToValidate="txtNombreUsuario" CssClass="lblError">Este campo es obligatorio</asp:RequiredFieldValidator>
                </div>
                <div class="division">
                    <asp:Label ID="lblContrasena" runat="server" Text="Contraseña:" CssClass="lbl"></asp:Label>
                    <asp:TextBox ID="txtContrasena" runat="server" CssClass="txt" TextMode="Password"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvContrasena" runat="server" ControlToValidate="txtContrasena" CssClass="lblError">Este campo es obligatorio</asp:RequiredFieldValidator>
                </div>
                <div class="division">
            ...
            <div class="grupoAux">
                <div class="division" style="width: 23%;">
                    <asp:Label ID="lblPrivilegiosUsuario" runat="server" Text="Privilegios:" CssClass="lbl"></asp:Label>
                    <asp:TextBox ID="txtPrivilegiosUsuario" runat="server" CssClass="txt" Text="Medico" ReadOnly="True" Enabled="false" />
                </div>
                <div style="display: flex; align-items: center;">
                    <asp:Button ID="btnAgregarMedico" runat="server" Text="Agregar médico" CssClass="btn" OnClick="btnAgregarMedico_Click" />
